...
fullSongInfo = pd.read_csv('C:\\Users\\mattf\\Desktop\\insight\\THE_PROJECT\\final\\model\\newSongsCoded.csv')
newSongs = pd.read_csv('C:\\Users\\mattf\\Desktop\\insight\\THE_PROJECT\\final\\model\\X.csv')
...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
        ...
        html.Div(
            [   
                html.Img(
                    src='https://amp.businessinsider.com/images/55801a50eab8ea1f1a3304f1-750-225.jpg',
                ...
                html.Img(
                    src='http://hdwallpapers2013.com/wp-content/uploads/2012/12/Twitter-Vector-Wallpaper.png',
                    className='three columns',
                    style={
                        'height': '15%',
                        'width': '15%',
        ...
        html.Div(
            [
                html.Div(
                    children='Welcome to SPOTting the hits! Here you can harness the immense musical library of Spotify along with trendiness of Twitter to produce a playlist of songs that are about to take off! Stay ahead of the curve (and your friends) by SPOTting the hits before they make it big! Just answer a few questions first:',
                    style={
                        'textAlign':'center',
                        'color':colors['text'],
                        'margin-top':50,
        ...
        html.Div(
            [
                html.Div([
                    html.Div(
                        children='Are there any artists you want to excluded?',
                        style={
                            'textAlign':'center',
                            'color':colors['text'],
                            'margin-top': 50,
...
def embed_playlist(n_clicks):
    ...
    link = html.Iframe()
    if n_clicks > 0:
        link = html.Iframe(src="https://open.spotify.com/embed/user/1268126297/playlist/6ut8CWc9CUP1V9iLg4nPkL", style={'width':800, 'height':800, 'frameborder':25, 'allowtransparency':True, 'allow':'encrypted-media'})
    return link
...
def embed_image(n_clicks):
    ...
    if n_clicks > 0:
        link = html.Img(src=url, style={'width':500, 'height':500, 'margin':100},)
    return link
